...
from praxi_backend.appointments.views import (
    # Appointments
...
urlpatterns = [
    ...
    path('operation-types/<int:pk>/', OperationTypeDetailView.as_view(), name='operation_types_detail'),
    ...
    path('op-dashboard/<int:pk>/status/', OpDashboardStatusUpdateView.as_view(), name='op_dashboard_status'),
    ...
    path('resource-calendar/resources/', ResourceCalendarResourcesView.as_view(), name='resource_calendar_resources'),
    ...
    path('patient-flow/<int:pk>/status/', PatientFlowStatusUpdateView.as_view(), name='patient_flow_status'),
    ...
    path('practice-hours/<int:pk>/', PracticeHoursDetailView.as_view(), name='practice_hours_detail'),
